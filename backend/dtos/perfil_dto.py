...
class AtualizarFotoDTO(BaseModel):
    foto_base64: str = Field(
        ..., description="Imagem de perfil cropada, codificada em base64 (data URL)"
    )

    _validar_foto = field_validator("foto_base64")(
        validar_string_obrigatoria("Foto", tamanho_minimo=100)
    )
