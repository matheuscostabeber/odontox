...
import { shortDate, idade, statusMeta, plural } from '@/lib/odontox/format';
import { ChevronLeft, Plus, Calendar, AlertTriangle } from '@/components/odontox/icons';
import Avatar from '@/components/odontox/Avatar';
import Button from '@/components/odontox/Button';
import StatusBadge from '@/components/odontox/StatusBadge';
...
function DataItem({ label, value, tabular, breakAll }: { label: string; value: string; tabular?: boolean; breakAll?: boolean }) {
  return (
    <div>
