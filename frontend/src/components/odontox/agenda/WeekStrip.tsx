import { addDays, parseDate } from "@/lib/odontox/format";
import { ACCENT, TODAY } from "@/lib/odontox/constants";
...
export default function WeekStrip({ viewDate, onSelect }: WeekStripProps) {
