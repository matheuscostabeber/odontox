...
import { shortDate } from '@/lib/odontox/format';
...
export default function AtendimentoFormModal({ consultaId }: { consultaId: number }) {
  ...
  const save = () => { saveAtendimento(consultaId, form, existing ? existing.id : undefined); close(); };
