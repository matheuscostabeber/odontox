...
import { fmtDate, endTime, statusMeta } from '../../utils/format';
import { Check, Pencil } from '../icons';
import Modal from '../Modal';
import Avatar from '../Avatar';

const actBtn = (bg, color, border) => ({ display: 'inline-flex', alignItems: 'center', gap: 7, background: bg, color, border: border || 'none', borderRadius: 9, padding: '10px 15px', fontSize: 13.5, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' });

export default function ConsultaDetailModal({ id }) {
  ...
  return (
    <Modal onClose={close} maxWidth={480} headerExtra={header}>
...
function Info({ label, value, tabular }) {
  return (
    <div>
