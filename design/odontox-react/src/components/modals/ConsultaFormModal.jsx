...
import { DURACAO_OPTIONS, STATUS_OPTIONS, TODAY } from '../../utils/constants';
import Modal from '../Modal';
import ModalFooter from '../ModalFooter';
import { Select, TextInput, TextArea } from '../Field';

export default function ConsultaFormModal({ entity, prefill }) {
  const { patients, dentists, saveConsulta } = useClinic();
  const { close } = useModal();

  const initial = entity
    ? { id: entity.id, pacienteId: entity.pacienteId, dentistaId: entity.dentistaId, data: entity.date, hora: entity.hora, duracao: entity.duracao, procedimento: entity.procedimento, status: entity.status, observacoes: entity.obs }
    : {
        id: null,
        ...
        hora: '09:00', duracao: 60, procedimento: '', status: 'agendada', observacoes: '',
      };
