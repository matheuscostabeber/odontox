import { minutes, endTime, statusMeta } from '../../utils/format';
import { START_H, HOUR_H } from '../../utils/constants';

// Um bloco de consulta posicionado na coluna do dentista.
export default function ConsultaBlock({ consulta, patientName, dentistColor, onClick }) {
  ...
  return (
    <div
      onClick={onClick}
      style={{ position: 'absolute', top, left: 6, right: 6, height: h, background: sm.bg, border: '1px solid ' + sm.border, borderLeft: '3px solid ' + dentistColor, borderRadius: 9, padding: '7px 9px', cursor: 'pointer', overflow: 'hidden', opacity: cancel ? 0.62 : 1, display: 'flex', flexDirection: 'column', gap: 1 }}
    >
